...
// A click-to-play video facade: a poster + play button that swaps to an
// autoplaying embed on click (the iframe loads only when activated). Honors a
// CMS-provided poster; frame is always 16:9. If the URL isn't an embeddable
// YouTube/Vimeo link it opens the original in a new tab instead of dead-ending.
// Shared by the discipline Showreel and project-gallery `video` items.
